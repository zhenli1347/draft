...
namespace std {
  ...
  constexpr ldiv_t div(long int numer, long int denom);                 // see \ref{library.c}
  constexpr lldiv_t div(long long int numer, long long int denom);      // see \ref{library.c}
...
#define @\defnlibxname{cpp_lib_ranges_repeat}@                     202207L // also in \libheader{ranges}
...
#define @\defnlibxname{cpp_lib_ranges_stride}@                     202207L // also in \libheader{ranges}
...
\begin{footnote}
That is, \tcode{a < b}, \tcode{a == b}, and \tcode{a > b} can all be \tcode{false}.
\end{footnote}
